---
description: Log an error/failure from agentic coding. Focuses on identifying USER mistakes in prompting, context management, or harness configuration.
allowed-tools: Read, Write, Bash(cat:*), Bash(ls:*), Bash(mkdir:*), Bash(wc:*), Glob
---

You are helping the user log an error/failure that just occurred during agentic coding.

## PRIMARY GOAL

Identify what the **USER** did wrong in their prompting, context management, or harness configuration. This is about building USER skill, not cataloging model failures.
...
2. **Ask 5-8 pointed questions focused on USER behavior.** Be direct. Examples:
   ...
   - "Did you check the output before moving on, or trust it blindly?"
   - "Were you being lazy or precise with your instruction?"
...
- After logging, briefly suggest if this pattern warrants a CLAUDE.md rule or a hook
